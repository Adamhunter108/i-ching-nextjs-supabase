    ...
    return (
        <>
            ...
            >
                ...
                <p className="text-sm text-gray-400 flex justify-center">{user ? `Signed in as ${user.email}` : null}</p>
                ...
                {user ? (
                    <div>
                        ...
                        <Link href="/profile">
                            <div
                                className={`${currentRoute === "/profile" ? "text-indigo-500" : "text-gray-300"} "justify-center grid gap-1 hover:bg-gray-700/40 hover:text-indigo-500 px-3 py-4 rounded-md text-xl font-medium inline-block"`}
                            >
                ...
                <Link href="/about">
                    <div
                        className={`${currentRoute === "/about" ? "text-indigo-500" : "text-gray-300"} "justify-center grid gap-1 hover:bg-gray-700/40 hover:text-indigo-500 px-3 py-4 rounded-md text-xl font-medium"`}
                    >
