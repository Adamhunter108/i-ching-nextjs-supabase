            ...
            <div className="relative md:bg-gray-900/90 backdrop-blur-sm md:p-6 rounded-xl">
              <div className="lg:grid lg:grid-cols-2 lg:gap-6">
                ...
                <h1 className="text-xl">How to use this app:</h1>
                  ...
                  <p className="pt-2">
                  To use this app, all you need to do is press the Divinate button.  We recommend doing only one reading a day and sitting with the result.  Sign in for free to save your hexagrams and view them on your profile page.
                  </p>
                  <p className="pt-2">
                ...
                <div className="flex justify-center cursor-pointer mt-1">
                  <Link href="https://github.com/Adamhunter108/i-ching-nextjs-supabase" target="_blank">
