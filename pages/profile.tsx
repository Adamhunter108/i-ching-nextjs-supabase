        ...
        <div className="max-w-max lg:max-w-7xl mx-auto">
          <div className="relative z-10 mb-8 md:mb-2 md:px-6">
            <div className="text-base max-w-prose lg:max-w-none">
              <h2 className="leading-6 text-gray-400 font-semibold tracking-wide uppercase">Profile for</h2>
              <p className="mt-2 text-lg leading-8 font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-indigo-200 to-teal-200 font-carter sm:text-4xl">
              {user.email}
              </p>
            </div>
          </div>
